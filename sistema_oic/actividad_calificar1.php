...
<html lang="es">
  ...
  <body>
    ...
    <img src="img/Logo Gobierno-Inclusión VColorPNG.png" width="auto" height="30" class=" align-left" alt="" loading="lazy">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-light rounded shadow-sm w-100">
          <img class="mr-3" src="img/Logo Gobierno-Inclusión VColorPNG.png" alt="" width="auto" height="48">
          <div class="lh-100">
            <h6 class="mb-0 text-muted lh-100">INCLUSIÓN</h6>
